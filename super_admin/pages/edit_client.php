...
if ($_SESSION['Autoriser'] != "oui") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = $database->query("UPDATE client SET NOM = '$Nom', PRENOM = '$Prenom', SEXE = '$Genre', DATENAIS = '$DateNais' , LIEUNAIS = '$LieuNais', PROFESSION = '$Profession', PAYS = '$Pays', VILLE = '$Ville', QUARTIER = '$Qtier', TEL = '$Phone', EMAIL = '$Email', PROFIL = '$Avatar' WHERE IDCLT = '$id'");
            ...
            <div class="Form__container content__padding">
                <div class="Form">
                    <div class="Form__header">
                        <a href="liste_client.php" class="Path">
                            <i class="fa-solid fa-mail-reply"></i>
                            <small>retour</small>
                        </a>
                        <div class="Title">
                            <h3>Modifier le client : <?php echo $Call['NOM'] . " ";
                                                        echo $Call['PRENOM']; ?></h3>
                        </div>
                    </div>
                            ...
                            <div class="Identity__content">
                                ...
                                <div class="Secondly__group">
                                    <div class="Input__box">
                                        ...
                                        <input type="text" id="Nom" name="Nom" maxlength="30" autocomplete="none" value="<?php echo $Call['NOM']; ?>" />
                                        <small class="Message_err"></small>
                                    </div>

                                    <div class="Input__box">
                                        <label for="Prenom">Prenom : </label>
                                        <input type="text" id="Prenom" name="Prenom" maxlength="20" autocomplete="none" value="<?php echo $Call['PRENOM']; ?>" />
                                        <small class="Message_err"></small>
                                    </div>

                                    <div class="Input__box">
                                        <label for="Genre">Genre : </label>
                                        <input type="text" name="Genre" value="<?php echo $Call['SEXE']; ?>" />
                                        <small class="Message_err"></small>
                                    ...
                                    <div class="Input__box">
                                        ...
                                        <input type="date" id="Date-Nais" name="Date-Nais" value="<?php echo $Call['DATENAIS']; ?>" />
                                        <small class="Message_err"></small>
                                    </div>
                        ...
                        <div class="Contact__info">
                            ...
                            <div class="Info__secondly">
                                <div class="Input__box">
                                    ...
                                    <input type="text" id="Pays" name="Pays" maxlength="15" autocomplete="none" value="<?php echo $Call['PAYS']; ?>" />
                                    <small class="Message_err"></small>
                                </div>
                                <div class="Input__box">
                        ...
                        <div class="Confidence">
                            ...
                            <div class="Save__and__Other">
                                <div class="Before__Save">
                                    <label for="Directory">Après la modification du client :</label>
                                ...
                                <div class="Login__button">
                                    ...
                                    <a href="../ressource_humaine/liste_client.php">
