            ...
            if (in_array($Extension, $AllExtension)) {
                ...
                if ($row == 0) {
                    ...
                    if (isset($Directory)) {
                        switch ($Directory) {
                            case '1':
                                header('location: ../pages/liste_client.php');
                                break;
                            case '2':
                                header('location: ../pages/ajout_client.php');
                                break;
                            case '3':
                                header('location: ../pages/');
                                break;
                            default:
                                header('location: ../pages/gestion_client.php');
                                break;
                        }
                    } else {
                        header('location: ../pages/gestion_client.php');
                    ...
                    echo "
                    <script>alert('Id existant !')</script>
                    ";
                }
            }else {
                header("location: ../pages/ajout_client.php?msg=La photo doit être à l'un des formats : jpg, jpeg, png !");
            }
        } else {
            header('location: ../pages/ajout_client.php?msg=La photo ne doit pas dépasser 1 Mo !');
        }
    } else {
        if ($row == 0) {
            if (!$Pass == "") {
                ...
                if (isset($Directory)) {
                    ...
                    header('location: ../super_admin/pages/gestion_client.php');
                }
            }
        } else {
            echo "
