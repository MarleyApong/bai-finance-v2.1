...
<head>
    <?php
    $Title = 'Gestion des comptes : Annuel';
                            ...
                            <div class="General">
                                ...
                                <div class="Details_cpte">
                                    ...
                                    <div class="Name_cpte">
                                        ...
                                        <?php
                                        $CheckTotal = $database->query("SELECT SUM(SOLDE) FROM `compte`,`client` WHERE compte.IDCLT = client.IDCLT AND IDCPTE LIKE '4%' ");
                            ...
                            <div class="Detail">
                                ...
                                <div class="RecentOrders">
                                    <table>
                                        ...
                                        <tbody>
                                            <?php
                                            $Checkcpt = $database->query("SELECT * FROM `compte`,`client` WHERE compte.IDCLT = client.IDCLT AND IDCPTE LIKE '4%' ");
                                            if ($Checkcpt->rowCount() > 0) {
                                                while ($Datacpt = $Checkcpt->fetch()) {
                                                    if (substr($Datacpt['IDCPTE'], 0, 3) == '420') {
