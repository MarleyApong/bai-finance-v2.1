<?php
    ...
    if ($_SESSION['Autoriser']!= "oui") {
        ...
        $req = $database->prepare("SELECT * FROM compte WHERE IDCLT = ? AND TYPE = 'Tontine'");
            ...
            <div class="Form__container content__padding">
                <div class="Form">
                    ...
                    <div class="Login__button">
                        <a href="../compte/compte_epargne.php">
                            <i class="fa-solid fa-line-chart"></i>
                            <span>Compte Epargne</span>
                        </a>
                        <a href="../compte/compte_annuel.php">
                            <i class="fa-solid fa-line-chart"></i>
    ...
    <script>
        $(document).ready(() => {
            ...
            $.ajax ({
                ...
                data: {search: 'search',action2:action2,search_txt:search_txt},
                success:  (Response) => {
                    // alert(Response);
                    $("tbody").html(Response);                    
                }
