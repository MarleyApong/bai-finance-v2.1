<?php
    ...
    if ($_SESSION['Autoriser']!= "oui") {
        ...
        $req = $database->prepare("SELECT * FROM compte WHERE IDCLT = ? AND TYPE = 'Annuel'");
    ...
    <script>
        $(document).ready(() => {
            ...
            $.ajax ({
                ...
                data: {search: 'search',action3:action3,search_txt:search_txt},
                success:  (Response) => {
                    // alert(Response);
                    $("tbody").html(Response);                    
                }
